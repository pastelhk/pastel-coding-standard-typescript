...
function getFlattenRulesFromConfig(config) {
...
const baseBestPracticesRules = getFlattenRulesFromConfig(
  airbnbBase.configs.bestPractices,
)
const baseErrorsRules = getFlattenRulesFromConfig(airbnbBase.configs.errors)
const baseES6Rules = getFlattenRulesFromConfig(airbnbBase.configs.es6)
const baseImportsRules = getFlattenRulesFromConfig(airbnbBase.configs.imports)
const baseStyleRules = getFlattenRulesFromConfig(airbnbBase.configs.style)
const baseVariablesRules = getFlattenRulesFromConfig(
  airbnbBase.configs.variables,
)
...
export default [
  ...
  importPlugin.flatConfigs.typescript,
  {
    ...
    rules: {
      ...
      // https://eslint.style/rules/ts/keyword-spacing.md
      'keyword-spacing': 'off',
      ...
      // https://eslint.style/rules/ts/no-extra-semi.md
      'no-extra-semi': 'off',
